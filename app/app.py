...
def hello_world():
    ...
    if request_type_str == 'GET':
        ...
        if str(studentgender) =='' or str(studentiq) =='' or str(studentparentincome) =='' or str(studentparentencouragement) =='':
            ...
            predictions = clf.predict([np_arr])  
            predictions_to_str = str(predictions)
            #return predictions_to_str
            return render_template('index.html', href2='The probability of this student  (gender:'+str(studentgender)+' , IQ:'+str(studentiq)+',IQ:'+str(studentiq)', parentincome:'+str(studentparentincome)', parentencouragement:'+str(studentparentencouragement)' going to university is) :'+predictions_to_str)
